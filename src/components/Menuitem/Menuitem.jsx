...
const Menuitem = ({title, imageUrl, size}) => {
  return (
        <div style={{backgroundImage: `url(${imageUrl})`}} className={`${size} menu-item hover:cursor-pointer  w-[30%] h-60 flex flex-auto felx-1 items-center justify-center mx-2 my-2 rounded-xl bg-center bg-cover scale-100 ease-in-out duration-1000 hover:-translate-y-2`} >
